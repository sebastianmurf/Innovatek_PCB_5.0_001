...
#define SHUNT_PRE_CHARGE_TIME_IN_SECa            412
    #define SHUNT_PRE_CHARGE_TIME_IN_SECn                1
#define SHUNT_POST_CHARGE_TIME_IN_SECa           413
    #define SHUNT_POST_CHARGE_TIME_IN_SECn               1
...
#define DYNAMIC_CAPDI_MODEa                    420
    #define DYNAMIC_CAPDI_MODEn                        1
#define PRE_PURE_CURRENTa                      421
    #define PRE_PURE_CURRENTn                          2
#define PURE_CURRENTa                          423
    #define PURE_CURRENTn                              2
#define WASTE_CURRENTa                         425
    #define WASTE_CURRENTn                             2
#define PUMP_MANUAL_SPEEDa                     427
    #define PUMP_MANUAL_SPEEDn                         2
#define PUMP_MANUAL_MODEa                     429
    #define PUMP_MANUAL_MODEn                         2
