...
{	
	...
	/*
	//DAC INIT
	//make DAC chip select pin as output
	DAC_PFR &= ~DAC_CS_PIN;    //Select CPIO function
	DAC_PDOR |= DAC_CS_PIN;     //Set Pin to turn off leds
	DAC_DDR |= DAC_CS_PIN;      //Make led pins outputs
	*/
	//LED_INIT;
    //Button_Init();
    Adc_AdcHardwareInit();
