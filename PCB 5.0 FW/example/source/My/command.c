                                ...
                                switch(sub_id){
                                    case 0: //ShuntPostPureStepTimeInSec//WastePreShuntTimeInSec 
                                      if(strcmp(CommandFormat.Para,"?")!=0){
                                            ...
                                            RandomMemWrite(WASTE_PRE_SHUNT_TIME_IN_SECa,u.c,WASTE_PRE_SHUNT_TIME_IN_SECn);
                                        }
                                    ...
                                    case 1: //ShuntPostWasteStepTimeInSec 
                                      if(strcmp(CommandFormat.Para,"?")!=0){
                                            ...
                                            RandomMemWrite(WASTE_POST_SHUNT_TIME_IN_SECa,u.c,WASTE_POST_SHUNT_TIME_IN_SECn);
                                        }
