...
#define PRODUCT_TYPE PRODUCT_DIUSE
...
#define CVS_CIP CVS_CIP_NO //for CFO, always CVS CIP
        ...
        #if(CVS_CIP==CVS_CIP_NO)
            #define DEVICE_VERSION 	"P3.B4.H4.F1.T5.4"	//must be 16 char long as it is center justified for LCD
        #else
            #define DEVICE_VERSION 	"P3.B4.H4.F2.T5.4"	//must be 16 char long as it is center justified for LCD
        #endif
    #endif
    #if(MANUFACTURER==MANUFACTURER_VOLTEA)
...
#else
    #define PAE_PURE_STEP_VOLT_MIN_VAL 0
    #define PAE_PURE_STEP_VOLT_DEF_VAL 25   //17   //14=1.4
    #define PAE_PURE_STEP_VOLT_MAX_VAL 120
#endif
...
#else
    #define PAE_WASTE_STEP_VOLT_MIN_VAL 0
    #define PAE_WASTE_STEP_VOLT_DEF_VAL 25  //14  //1.4
    #define PAE_WASTE_STEP_VOLT_MAX_VAL 120
#endif
//------------------------------------------------------------------------------
...
#else
    #define PAE_PREPURIFY_STEP_VOLT_MIN_VAL 0
    #define PAE_PREPURIFY_STEP_VOLT_DEF_VAL 15   //17   //14=1.4
    #define PAE_PREPURIFY_STEP_VOLT_MAX_VAL 120
#endif
