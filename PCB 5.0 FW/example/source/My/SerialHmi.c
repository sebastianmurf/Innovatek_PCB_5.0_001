...
{	switch(DisplayPage){
		...
		*/
		...
		case PARA_SET_29_2:     //SELECT BYPASS OPTIONS
                ...
                case PARA_SET_40_0:		strcpy(LcdLine1," P-PURE CURRENT ");
								...
								LcdLine2[9]= SerialHmiPassword[3];
								switch(KeyPressCounter){
										case 0:	CurPos = 207; CursorActiveFlag = TRUE;break;
										case 1: CurPos = 208; CursorActiveFlag = TRUE;break;
										case 2: CurPos = 209; CursorActiveFlag = TRUE;break;
										//case 3: CurPos = 209; CursorActiveFlag = TRUE;break;
										default: CursorActiveFlag = FALSE;break; 
								}
								break;  
		...
		*/
		...
		case OUTPUT_TEST_10:			strcpy(LcdLine1,"   RELAY TEST   ");
									CursorActiveFlag = FALSE;
									sprintf(CopyBuff,"Pump:%s",((DigitalOutput & 0x0100)>0)? "OFF":"ON");
                                                                        JustifyCenterForLcdLine(CopyBuff,LcdLine2);
									LcdLine2[0] = 0x7F;
									LcdLine2[15] = 0x7E;
									break;                            
		case OUTPUT_TEST_11:		        strcpy(LcdLine1,"   RELAY TEST   ");
									CursorActiveFlag = FALSE;
									sprintf(CopyBuff,"PAE:%s",((DigitalOutput & 0x0100)>0)? "OFF":"ON");
			...
			case KEY_ENTER:
				...
				{	case LOGOUT_0:			SwitchFromLogoutToAutoMode(0); break;
					...
					case PARA_SET_27:               DisplayPage = PARA_SET_27_0; break;
                                        ...
                                        #endif                           
                                        case PARA_SET_43:	VariableUnsignedInt2UserInput(ShuntPostPureStepTimeInSec);
											DisplayPage=PARA_SET_43_0;break;
                                        case PARA_SET_44:	VariableUnsignedInt2UserInput(ShuntPostWasteStepTimeInSec);
			...
			case KEY_EXIT:
				...
				{	//case LOGOUT_0:			break;
					...
					case PARA_SET_38_0:     DisplayPage = PARA_SET_38;  break;
                                        ...
                                        case PARA_SET_41_0:     DisplayPage = PARA_SET_40;  break;
                                        case PARA_SET_42_0:     DisplayPage = PARA_SET_41;  break;
                                        case PARA_SET_43_0:     DisplayPage = PARA_SET_42;  break;
                                        case PARA_SET_44_0:     DisplayPage = PARA_SET_43;  break;
